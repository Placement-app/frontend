...
export default function Clubs() {
  ...
  const AllData = async () => {
    const send = await fetch("http://localhost:5000/admin/clubs", {
      method: "GET",
      headers: {
  ...
  const Disable = async (cid, blocked) => {
    const send = await fetch("http://localhost:5000/admin/disable_club", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const Activate = async (cid) => {
    const send = await fetch("http://localhost:5000/admin/activate_club", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      ...
      <Modal className="mt-7" show={openModal} onClose={() => setOpenModal(false)}>
        ...
        <Modal.Body>
          ...
          <div className="flex w-full">
            <div style={{ width:200}}>
              <img className="rounded" src={`http://localhost:5000/admin/clublogo/${data.logo}`} />
            </div>
            <div className="ml-2">
              ...
              <h5 className="text-sm text-gray-500 font-bold">Club ID</h5>
          ...
          <div className="flex justify-center w-full">
            <Tooltip content="click to view in large size" >
              <img className="rounded" src={`http://localhost:5000/admin/clubverificationdocs/${data.docs}`} width={250} />
            </Tooltip>
          </div>
          ...
          <h5 className="text-sm text-gray-500 font-bold mt-4">Carousel</h5>
          {
            data.carousel.img == null ? <h5 className="text-md">No carousel</h5> : <div>
              ...
              <div className="flex justify-center">
                <img className="rounded" src={`http://localhost:5000/myclub/carousel/${data.carousel.img}`} style={{ height: 200 }} />
              </div>
      ...
      <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden border">
          ...
          <div className="overflow-x-auto">
            ...
            {clubs.length <= 0 ? <h5 className="w-full text-center p-10 text-gray-600 ">No records found</h5> : null}
