...
export default function RequestEvent() {
    ...
    const Request = async (e) => {
        ...
        if (data.content === "" || data.description === "" || data.timeStart === "" || data.timeEnd === "" || data.title === "") {
            ...
            const send = await fetch("http://192.168.1.35:5000/myclub/addevent", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const Requested = async (e) => {
        try {
            ...
            const send = await fetch("http://192.168.1.35:5000/myclub/verify_event", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const Remove = async () => {
        const send = await fetch("http://192.168.1.35:5000/myclub/remove_event", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
